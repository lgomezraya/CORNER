...
c     zhw1 auxiliar  matrix to help removing high LD markers
       double precision f11x,f22x,a1,a2,b1,b2,ri
       double precision f11,f12,f21,f22,del
       double precision cor1,cor2,cor3,cor4,cor5
       integer po1(18,nmar)
...
c      print*, " "
     ...
     @ ,po1(k,i1), "and ",po1(k,j1)
      ...
      write(25,*) " "
      write(25,*) " "
      write(25,*) "             ", ge(1,k,11),"          ",ge(2,k,i1) ,
     $"            ",ge(3,k,i1) 
      write(25,*) "_________________________________________"  
      write(25,*) ge(1,k,j1),"|", Nm11t11, Nm11t12, Nm11t22
      write(25,*) ge(2,k,j1), "|", Nm12t11 ,Nm12t12, Nm12t22
      write(25,*) ge(3,k,j1),"|", Nm22t11, Nm22t12,  Nm22t22
      write(25,*)"_________________________________________"  
      write(25,*) " "
 ...
 6566 continue
     ...
     & Nm12t22x,Nm22t11x, Nm22t12x, Nm22t22x,del,
     &f11,f12,f21,f22)
       r1=del/dsqrt(a1*a2*b1*b2)
       if(pr.eq.1) then
          write(25,*)  "LD estimates:"
      write(25,*)" EM algorithm r= ", r1
      write(25,*) ""
      if(cori.eq.9) then
      write(25,*)" Corner algorithm r= ", r11
      write(25,*)""
      endif
      write(25,*)""
      ...
      write (25,*) ""
      write (25,*) ""      
      write(25,*) "Haplotype Frequencies"
...
cccccccccccccccccccccccccccccccccccccccccccc
      ...
      if(Nm11t11+Nm11t12+Nm12t11.eq.0) then
         write (26,*) "1 " ,k,k, pox(i1),pox(j1)  
      endif
         if(Nm11t12+Nm11t22+Nm12t22.eq.0) then
         write (26,*) "2 ",k,k, pox(i1),pox(j1)  
      endif
         if(Nm11t11+Nm22t11+Nm22t12.eq.0) then
         write (26,*) "3 ",k,k, pox(i1),pox(j1)  
      endif
  
         if(Nm12t22+Nm22t12+Nm22t22.eq.0) then
         write (26,*) "4 ",k,k, pox(i1),pox(j1)  
         endif                  
...
ccccccccccccccccccccccccc          
 ...
 190  format(i3,1x,2I9,2x, i3,I15,2x,i15)
      enddo
      enddo
